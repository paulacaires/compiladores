class UCyanParser(Parser):
    ...
    @_('INT_CONST',
       ...
       'FALSE')
    def literal(self, p):
        return ('literal: %s, %s @ %d:%d' % ((p[0],) + self._token_coord(p)))
